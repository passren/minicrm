INSERT INTO `role` (`authority`, `description`) VALUES ('ROLE_ADMIN', '管理员');
INSERT INTO `role` (`authority`, `description`) VALUES ('ROLE_SALES', '销售人员');
INSERT INTO `role` (`authority`, `description`) VALUES ('ROLE_SALES_MANAGER', '销售经理');
