                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><label for="signedDate">签约时间</label>
                                ...
                                value="${com.minicrm.StringUtils.getDate(opportunity.signedDate, com.minicrm.ConstUtils.DATE_DAY_FORMAT)}" 
                        ...
                        <tr>
                            ...
                            <td colspan="2"><label for="txtReceiptDate">收款日期</label>
                                <g:textField id="txtReceiptDate" name="txtReceiptDate" 
                                    value="${com.minicrm.StringUtils.getDate(receivable?.receiptDate, com.minicrm.ConstUtils.DATE_DAY_FORMAT)}" 
                                    size="15"/>
                            </td>
                        </tr>
                        <tr>
